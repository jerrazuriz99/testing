...
class Tracer(StackInspector):
    ...
    """Funcion de rastreo que llama a imprimir los eventos y evita que rastreemos
    nuestros propios metodos
    ...
    * 'return' - el retorno de una funcion
    - Un frame: El frame de ejecucion actual, es decir, un objeto de rastreo (e.g.,
    una funcion).
    ...
    * frame.f_code - el codigo actual (Code) que tiene el atributo
    frame.f_code.co_name (el nombre del la funcion actual)
    """
